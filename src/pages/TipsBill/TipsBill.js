        ...
        <PaymentScreen>
          ...
          <Content>
            <div className="asd">
              ...
              <PaymentRow final>
                <Text><span className="text-primary">Tips</span><Label>20%</Label></Text>
                <Price><span>$</span>6.25</Price>
              </PaymentRow>
              <PaymentRow final>
          ...
          <Buttons>
            <Button dark>Pay $58.47</Button>
            <Button light>Split the bill</Button>
            <Button transparent>Edit a tip</Button>
          </Buttons>
        </PaymentScreen>
        <PoweredBy/>
      </Main>
